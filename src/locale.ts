  ...
  en: {
    message: {
      profile: {
        ...
        aboutMe: "About me: ",
        aboutMeText:
          "I am 30 years old, I am passionate about music and programming.",
        qualities: "Qualities: ",
        qualitiesText:
          "I am a fast learner, detailed-oriented, organized, team player and I am eager to learn.",
      },
      contact: {
        title: "Contact",
        footer: "Website design: Nailí Armeri",
      },
      technicalSkills: {
      ...
      education: {
        ...
        languages: {
          ...
          intermadiateHigh: "Intermediate High",
          italian: "Italian",
          native: "Native",
          spanish: "Spanish",
          title: "Languages",
  ...
  es: {
    message: {
      ...
      profile: {
        ...
        aboutMe: "Sobre mi: ",
        aboutMeText:
          "Tengo 30 años, soy un apasionado de la música y la programación.",
        qualities: "Cualidades: ",
        qualitiesText:
          "Aprendo rápido. Soy detallista y organizado. Me gusta trabajar en equipo y siempre estoy aprendiendo cosas nuevas.",
      },
      contact: {
        title: "Contacto",
        footer: "Diseño de página web: Nailí Armeri",
      },
      technicalSkills: {
      ...
      education: {
        ...
        languages: {
          ...
          intermadiateHigh: "Intermedio Alto",
          italian: "Italiano",
          native: "Nativo",
          spanish: "Español",
          title: "Idiomas",
